...
<div className="flex flex-wrap space-x-2">
  {product?.attributes.map(attribute => (
   ...
   <h1>Thông số</h1>
    <div data-aos="fade-up" className="flex flex-wrap space-x-2 items-center mb-[20px]">
      {showFullParameter ? product?.parameter : `${product?.parameter?.substring(0, 100)}...`}
    </div>
    <span onClick={toggleParameterVisibility} className="btn">
      {showFullParameter ? "Thu gọn" : "Xem thêm"}
    </span>
